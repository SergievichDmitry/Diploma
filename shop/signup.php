<?php
    ...
    {//здесь регистрируем
        ...
        if( empty($errors))
        {
            ...
            R::store($user);
            echo '<div style="color: green;">Регистрация прошла успешно!</div><hr><a href="/shop/index.php" class="link">Перейти на главную страницу</a><br>';
        }
        else
        {
            echo phpversion();
...
<a href="/shop/index.php" class="link">Перейти на главную страницу</a><br>
<H3>Уже зарегистрированы? Войдите в аккаунт: </H3>
<a href="/shop/login.php" class="link">Вход в систему</a><br><br>
